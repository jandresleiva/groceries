...
namespace Groceries.Controllers
{
    public class MarketsController : Controller
    {
        ...
        public MarketsController(GroceriesDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name")] Market market)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name")] Market market)
        {
            if (id != market.Id)
            {
                return NotFound();
